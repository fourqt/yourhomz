<?php
Assets::add_css(array('font-awesome.css','modern.min.css','uniform.default.min.css','switchery.min.css','waves.min.css','summernote.css','datepicker3.css','colorpicker.css','bootstrap-tagsinput.css','bootstrap-timepicker.min.css'));
