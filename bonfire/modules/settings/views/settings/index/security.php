<h3 class="no-m m-b-xs"><?php echo lang('bf_security'); ?></h3>
<hr class="m-t-xs">
    <div class="form-group<?php echo form_error('allow_register') ? $errorClass : ''; ?>">
        <div class="col-sm-10 col-sm-offset-2">
            ...
            <p class="help-block"><?php echo form_error('allow_register'); ?></p>
        </div>
    </div>
    <div class="form-group<?php echo form_error('user_activation_method') ? $errorClass : ''; ?>">
        <label class="col-sm-2 control-label" for="user_activation_method"><?php echo lang('bf_activate_method'); ?></label>
        <div class="col-sm-10">
            ...
            <p class="help-block"><?php echo form_error('user_activation_method'); ?></p>
        </div>
    </div>
    <div class="form-group<?php echo form_error('login_type') ? $errorClass : ''; ?>">
        ...
        <div class="col-sm-10">
            ...
            <p class="help-block"><?php echo form_error('login_type'); ?></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-10" aria-labelledby="use_usernames_label" role="group">
            <label class="radio-inline" for="use_username">
            ...
            <label class="radio-inline" for="use_email">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" id='allow_name_change_label'><?php echo lang('bf_display_name'); ?></label>
        <div class="col-sm-10" aria-labelledby='allow_name_change_label' role='group'>
            ...
            <div id="name-change-settings"<?php echo $settings['auth.allow_name_change'] ? '' : ' style="display:none"'; ?> class="form-inline m-t-xs">
                <div class="form-group no-s">
                    <input type="text" name="name_change_frequency" value="<?php echo set_value('auth.name_change_frequency', isset($settings['auth.name_change_frequency']) ? $settings['auth.name_change_frequency'] : ''); ?>" class="form-control" />
                    <label>&nbsp;&nbsp;<?php echo lang('set_name_change_frequency'); ?>&nbsp;&nbsp;</label>
                </div>
                <div class="form-group no-s">
                    <input type="text" name="name_change_limit" value="<?php echo set_value('auth.name_change_limit', isset($settings['auth.name_change_limit']) ? $settings['auth.name_change_limit'] : ''); ?>" class="form-control" />
                    <label>&nbsp;&nbsp;<?php echo lang('set_days'); ?></label>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-group<?php echo form_error('remember_length') ? $errorClass : ''; ?>" id="remember-length"<?php echo $settings['auth.allow_remember'] ? '' : ' style="display:none"'; ?>>
        ...
        <div class="col-sm-10">
            ...
            <p class="help-block"><?php echo form_error('remember_length'); ?></p>
        </div>
    </div>
    <div class="form-group<?php echo form_error('password_min_length') ? $errorClass : ''; ?>" id="password-strength">
        <label class="col-sm-2 control-label" for="password_min_length"><?php echo lang('bf_password_strength'); ?></label>
        <div class="col-sm-10">
            ...
            <p class="help-block"><?php echo (form_error('password_min_length') ? form_error('password_min_length') . '<br />' : '') . lang('bf_password_length_help'); ?></p>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label" id='password_options_label'><?php echo lang('set_option_password'); ?></label>
        <div class="col-sm-10" aria-labelledby='password_options_label' role='group'>
    ...
    <div class="form-group<?php echo form_error('password_iterations') ? $errorClass : ''; ?>">
        <label for="password_iterations" class="col-sm-2 control-label"><?php echo lang('set_password_iterations'); ?></label>
        <div class="col-sm-10">
            ...
            <p class="help-block"><?php echo (form_error('password_iterations') ? form_error('password_iterations') . '<br />' : '') . lang('bf_password_iterations_note'); ?></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <p class="help-block"><?php echo lang('set_reset_note'); ?></p>
        </div>
    </div>