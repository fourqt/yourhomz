...
echo form_open($formSubmitUrl, array('id' => 'module_form', 'class' => 'form-horizontal'));
    ...
    //------------------------------------------------------------------
?>
    <h3 class="no-m m-b-xs"><?php echo lang('mb_form_mod_details'); ?></h3>
    <hr class="m-t-xs">
    <fieldset id="module_details">      
        <div class="form-group<?php echo form_error('module_name') ? ' error' : ''; ?>">
            <label for="module_name" class="col-sm-2 control-label"><?php echo lang('mb_form_mod_name'); ?></label>
            <div class="col-sm-10">
                <input name="module_name" id="module_name" type="text" class="form-control" value="<?php echo set_value("module_name"); ?>" placeholder="<?php echo lang('mb_form_mod_name_ph'); ?>" />
                <span class="help-inline"><?php echo form_error('module_name'); ?></span>
                <p class="help-block"><a href="#" class="mb_show_advanced small"><?php echo lang('mb_form_show_advanced'); ?></a></p>
            </div>
        </div>
        <?php
        //--------------------------------------------------------------
        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-2">
                <div class="form-group mb_advanced<?php echo form_error('module_description') ? ' error' : ''; ?>">
                    <label for="module_description" class="col-md-2 control-label"><?php echo lang('mb_form_mod_desc'); ?></label>
                    <div class="col-md-10">
                        <input name="module_description" id="module_description" type="text" class="form-control" value="<?php echo set_value("module_description", lang('mb_form_mod_desc_ph')); ?>" placeholder="<?php echo lang('mb_form_mod_desc_ph'); ?>" />
                        <p class="help-block"><?php echo form_error('module_description'); ?></p>
                    </div>
                </div>
                <div class="form-group mb_advanced">
                    <label class="col-md-2 control-label" id="contexts_label"><?php echo lang('mb_form_contexts'); ?></label>
                ...
                <div class="form-group mb_advanced<?php echo form_error('form_action') ? ' error' : ''; ?>">
                    ...
                    <label class="col-md-2 control-label" id="form_action_label"><?php echo lang('mb_form_actions'); ?></label>
                ...
                <div class="form-group mb_advanced">
                    <label class="col-md-2 control-label" for="role_id"><?php echo lang('mb_form_role_id'); ?></label>
                    <div class="col-md-10">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10" id='mb_module_db'>
                <label class="radio-inline" for="db_no">
                ...
                <label class="radio-inline" for="db_create">
                ...
                <label class="radio-inline" for="db_exists">
    ...
    <fieldset id="db_details">
        <h3 class="m-b-xs"><?php echo lang('mb_form_table_details'); ?></h3>
        <hr class="no-m m-t-xs">
        ...
        <div class="form-group mb_advanced<?php echo form_error('table_name') ? ' error' : ''; ?>">
            <label for="table_name" class="col-md-3 control-label"><?php echo lang('mb_form_table_name'); ?></label>
            <div class="col-md-9">
                <input name="table_name" id="table_name" type="text" class="form-control" value="<?php echo set_value('table_name'); ?>" placeholder="<?php echo lang('mb_form_table_name_ph'); ?>" />
        ...
        <div class="form-group mb_advanced<?php echo form_error('form_error_delimiters') ? ' error' : ''; ?>">
            <label for="form_error_delimiters" class="col-md-3 control-label"><?php echo lang('mb_form_err_delims'); ?></label>
            <div class="col-md-9">
                <input name="form_error_delimiters" id="form_error_delimiters" type="text" class="form-control" value="<?php echo set_value("form_error_delimiters", "<span class='error'>,</span>"); ?>" />
                <span class="help-inline"><?php echo form_error('form_error_delimiters'); ?></span>
            </div>
        </div>
        <div class="form-group mb_advanced">
            <label for="textarea_editor" class="col-md-3 control-label"><?php echo lang('mb_form_text_ed'); ?></label>
            <div class="col-md-9">
        ...
        <div class="form-group mb_advanced<?php echo form_error('soft_delete_field') ? ' error' : ''; ?>">
            <label for="soft_delete_field" class="col-md-3 control-label"><?php echo lang('mb_soft_delete_field'); ?></label>
            <div class="col-md-9">
                <input name="soft_delete_field" id="soft_delete_field" type="text" class="form-control" value="<?php echo set_value('soft_delete_field', lang('mb_soft_delete_field_ph')); ?>" />
        ...
        <div class="form-group mb_advanced<?php echo form_error('deleted_by_field') ? ' error' : ''; ?>">
            <label for="deleted_by_field" class="col-md-3 control-label"><?php echo lang('mb_deleted_by_field'); ?></label>
            <div class="col-md-9">
                <input name="deleted_by_field" id="deleted_by_field" type="text" class="form-control" value="<?php echo set_value('deleted_by_field', lang('mb_deleted_by_field_ph')); ?>" />
                <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
        ...
        <div class="form-group mb_advanced<?php echo form_error('created_field') ? ' error' : ''; ?>">
            <label for="created_field" class="col-md-3 control-label"><?php echo lang('mb_form_created_field'); ?></label>
            <div class="col-md-9">
                <input name="created_field" id="created_field" type="text" class="form-control" value="<?php echo set_value('created_field', lang('mb_form_created_field_ph')); ?>" />
                <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
        ...
        <div class="form-group mb_advanced<?php echo form_error('created_by_field') ? ' error' : ''; ?>">
            <label for="created_by_field" class="col-md-3 control-label"><?php echo lang('mb_form_created_by_field'); ?></label>
            <div class="col-md-9">
                <input name="created_by_field" id="created_by_field" type="text" class="form-control" value="<?php echo set_value('created_by_field', lang('mb_form_created_by_field_ph')); ?>" />
                <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
        ...
        <div class="form-group mb_advanced<?php echo form_error('modified_field') ? ' error' : ''; ?>">
            <label for="modified_field" class="col-md-3 control-label"><?php echo lang('mb_form_modified_field'); ?></label>
            <div class="col-md-9">
                <input name="modified_field" id="modified_field" type="text" class="form-control" value="<?php echo set_value('modified_field', lang('mb_form_modified_field_ph')); ?>" />
                <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
        ...
        <div class="form-group mb_advanced<?php echo form_error('modified_by_field') ? ' error' : ''; ?>">
            <label for="modified_by_field" class="col-md-3 control-label"><?php echo lang('mb_form_modified_by_field'); ?></label>
            <div class="col-md-9">
                <input name="modified_by_field" id="modified_by_field" type="text" class="form-control" value="<?php echo set_value('modified_by_field', lang('mb_form_modified_by_field_ph')); ?>" />
                <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
        ...
        <div class="form-group mb_new_table<?php echo form_error('primary_key_field') ? ' error' : ''; ?>">
            <label for="primary_key_field" class="col-md-3 control-label"><?php echo lang('mb_form_primarykey'); ?></label>
            <div class="col-md-9">
                <input name="primary_key_field" id="primary_key_field" type="text" class="form-control" value="<?php echo set_value("primary_key_field", (isset($existing_table_fields[0]) && $existing_table_fields[0]['primary_key']) ? $existing_table_fields[0]['name'] : 'id'); ?>" />
                <span class="help-inline"><?php echo form_error('primary_key_field'); ?></span>
            </div>
        </div>
        <div id="field_numbers" class="form-group">
            <label class="col-md-3 control-label"><?php echo lang('mb_form_fieldnum'); ?></label>
            <div class="col-md-9">
                <div class="btn-group">
                <?php
                ...
                ?>
                    <a href="<?php echo site_url(SITE_AREA . '/developer/builder/create_module/' . $field_numbers[$ndx]); ?>"<?php echo $field_numbers[$ndx] == $field_total ? ' class="btn btn-default active"' : ' class="btn btn-default"'; ?>>
    ...
    <?php endif; ?>
    <div id="field<?php echo $count; ?>_details" class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo lang('mb_form_field_details') . " {$count}"; ?></h3>
        </div>
        <div class="panel-body">
            <div class="form-group m-t-md<?php echo form_error($viewFieldLabel) ? ' error' : ''; ?>">
                <label class="col-md-2 control-label" for="<?php echo $viewFieldLabel; ?>"><?php echo lang('mb_form_label'); ?></label>
                <div class="col-md-10">
                    <input name="<?php echo $viewFieldLabel; ?>" id="<?php echo $viewFieldLabel; ?>" type="text" class="form-control" value="<?php echo set_value($viewFieldLabel, isset($existing_table_fields[$count]) ? ucwords(str_replace('_', ' ', $existing_table_fields[$count]['name'])) : ''); ?>" placeholder="<?php echo lang('mb_form_label_ph'); ?>" />
                    <p class="help-block"><?php echo form_error($viewFieldLabel); ?></p>
                </div>
            </div>
            <div class="form-group<?php echo form_error($viewFieldName) ? ' error' : ''; ?>">
                <label class="col-md-2 control-label" for="<?php echo $viewFieldName; ?>"><?php echo lang('mb_form_fieldname'); ?></label>
                <div class="col-md-10">
                    <input name="<?php echo $viewFieldName; ?>" id="<?php echo $viewFieldName; ?>" type="text" class="form-control" value="<?php echo set_value($viewFieldName, isset($existing_table_fields[$count]) ? $existing_table_fields[$count]['name'] : ''); ?>" maxlength="30" placeholder="<?php echo lang('mb_form_fieldname_ph'); ?>" />
            ...
            echo form_dropdown($viewFieldType, $view_field_types, set_value($viewFieldType, $default_field_type), lang('mb_form_type'), 'class="form-control"', '<p class="help-block">' . form_error($viewFieldType) . '</p>','col-md-2 control-label','col-md-10');
            echo form_dropdown($dbFieldType, $db_field_types, set_value($dbFieldType, isset($existing_table_fields[$count]) ? $existing_table_fields[$count]['type'] : ''), lang('mb_form_dbtype'), 'class="form-control"', '<p class="help-block">' . form_error($dbFieldType) . '</p>','col-md-2 control-label','col-md-10');
            ...
            <div class="form-group <?php echo form_error($dbFieldLength) ? 'error' : ''; ?>">
                <label class="col-md-2 control-label" for="<?php echo $dbFieldLength; ?>"><?php echo lang('mb_form_length'); ?></label>
                <div class="col-md-10">
                    <input name="<?php echo $dbFieldLength; ?>" id="<?php echo $dbFieldLength; ?>" type="text" class="form-control" value="<?php echo set_value($dbFieldLength, $default_max_len); ?>" placeholder="<?php echo lang('mb_form_length_ph'); ?>" />
                    <p class="help-block"><?php echo form_error($dbFieldLength); ?></p>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label" id="<?php echo $validationLbl; ?>"><?php echo lang('mb_form_rules'); ?></label>
                <div class="col-md-10" aria-labelledby="<?php echo $validationLbl; ?>" role="group">
                    <?php
                    ...
                    <?php endforeach; ?>
                    <a class="help-block small mb_show_advanced_rules" href="#"><em><?php echo lang('mb_form_show_more'); ?></em></a>
                </div>
            </div>
            <div class="form-group mb_advanced">
                <label class="col-md-2 control-label" id="<?php echo $validLimitLbl; ?>"><?php echo lang('mb_form_rules_limits'); ?></label>
                <div class="col-md-10" aria-labelledby="<?php echo $validLimitLbl; ?>" role="group">
                    <?php
                    ...
                    ?>
                    <span class="faded">
                        <label class="radio-inline" for="<?php echo $validationRulesLimitCount; ?>">
