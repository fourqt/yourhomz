...
{
    protected $permissionCreate = 'Projects.Reports.Create';
    protected $permissionDelete = 'Projects.Reports.Delete';
    protected $permissionEdit   = 'Projects.Reports.Edit';
    protected $permissionView   = 'Projects.Reports.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/reports/projects/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_projects()) {
                ...
                redirect(SITE_AREA . '/reports/projects');
            }
