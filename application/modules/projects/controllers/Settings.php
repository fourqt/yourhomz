...
{
    protected $permissionCreate = 'Projects.Settings.Create';
    protected $permissionDelete = 'Projects.Settings.Delete';
    protected $permissionEdit   = 'Projects.Settings.Edit';
    protected $permissionView   = 'Projects.Settings.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/settings/projects/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_projects()) {
                ...
                redirect(SITE_AREA . '/settings/projects');
            }
